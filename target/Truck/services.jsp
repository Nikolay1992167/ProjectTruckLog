...
<html>
<head>
<title>Truckage a Autos and Transportation Category Flat Bootstrap Responsive Website Template | Services :: w3layouts</title>
...
<div class="header">
	<div class="container">
		<div class="w3l_header_left">
			<ul>
				<li><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span>+ (375) 29 231 72 72</li>
				<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span><a href="minickola50@gmail.com">nikolay@gmail.com</a></li>
			</ul>
		</div>
		<div id="example2">
			<div class="wrapper2">
